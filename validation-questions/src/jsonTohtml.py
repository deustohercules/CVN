...
for f in files:
    ...
    string = string + '<left > <a href="https://github.com/deustohercules/CVN"> Repositorio Principal.</a> </left >'
    string = string + '<right > <a href="https://github.com/deustohercules/CVN/blob/main/validation-questions/sparql-query/README.md"> Preguntas Sparql y results.</a> </right>'
    string = string + '</div>'
